...
// 注意到 Role1 除了正常的枚举成员外，还伴生了另一组成员。Role1 既可以使用枚举成员的名称来索引，也可以用值来索引
// 将枚举类型的 ts 源码编译为对应的 js：
/*
var Role1;
(function (Role1) {
...
// 常量枚举：添加 const enum 关键字，其特点是在编译阶段会被移除。
const enum Month {
    Jan,
    Feb,
    Mar,
...
/*
小结：
    需要掌握一个思维方法：将程序中不容易记忆的硬编码，或者未来可能改变的常量，抽取出来定义成枚举类型，以提高程序代码的可读性和可维护性。
